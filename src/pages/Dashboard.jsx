  ...
  return (
    <div>
      <div style={{ background: G.primary, borderRadius: 16, padding: '20px 20px', marginBottom: 20, color: G.white }}>
        ...
        {!checkedIn ? (
          <Button onClick={doCheckIn} disabled={loading} variant="amber" style={{ background: 'rgba(255,255,255,0.15)', width: '100%', justifyContent: 'center', padding: '12px' }} icon="checkin">
